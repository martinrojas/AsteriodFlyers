...
function lensInit() {
	...
	for ( var i = 0; i < 8000; i ++ ) {
		...
		mesh.position.x = 10000 * ( 2.0 * Math.random() - 1.0 );
		mesh.position.y = 10000 * ( 2.0 * Math.random() - 1.0 );
		mesh.position.z = 10000 * ( 2.0 * Math.random() - 1.0 );
	...
	ambient.color.setHSL( 0.1, 0.3, 1 );
	scene.add( ambient );
